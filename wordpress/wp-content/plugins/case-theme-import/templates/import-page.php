                            ...
                            <form method="post" class="ct-ie-demo-item" data-demo="demo-<?php echo $demo ?>"
                                ...
                                <div class="ct-ie-item-inner">
                                    ...
                                    <div class="ct-ie-meta">
                                        ...
                                        <button class="ct-import-btn ct-import-submit button button-primary"
                                                name="ct-import-submit"
                                                value="<?php echo base64_encode($demo) ?>"><?php echo $demo_installed === true ? esc_html__('Update Demo', CTI_TEXT_DOMAIN) : esc_html__('Import Demo', CTI_TEXT_DOMAIN) ?></button>
                                        <?php
                                        if ($demo_installed === true) {
                                            wp_nonce_field('ct-reset', '_wp_nonce');
                                            ?>
                                            <button class="ct-import-btn ct-delete-demo button button-primary"
                                                    name="ct-ie-delete-demo"
                                                    value="<?php echo base64_encode($demo) ?>"><?php esc_html_e('Reset Site', CTI_TEXT_DOMAIN) ?></button>
                                            <?php
                                        }
                                        ?>
                                    </div>
