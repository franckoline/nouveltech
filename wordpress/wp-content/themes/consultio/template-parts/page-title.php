...
if($custom_pagetitle != 'themeoption' && $custom_pagetitle != '' && isset($ptitle_breadcrumb_page) && $ptitle_breadcrumb_page != 'themeoption') {
...
if($pagetitle == 'show') : ?>
    <div id="pagetitle" class="page-title bg-image <?php if($ptitle_overlay == 'hidden') { echo 'overlay-hide'; } ?>">
        <div class="container">
