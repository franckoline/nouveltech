            ...
            <div class="ct-modal-content">
                <form role="search" method="get" class="search-form-popup" action="<?php echo esc_url(home_url( '/' )); ?>">
                    <div class="searchform-wrap">
                        <input type="text" placeholder="<?php echo esc_attr__('Enter Keywords...', 'consultio'); ?>" id="search" name="s" class="search-field" />
                        ...
                        <div class="entry-body">
                            <div class="entry-holder">
                                ...
                                <?php } else { ?>
                                    <div class="entry-readmore">
                                        <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                            <?php echo esc_html__('Read more', 'consultio'); ?><i class="fac fac-angle-double-right space-left"></i>
                                        </a>
                                    </div>
                                <?php } ?>
                            </div>
                ...
                <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                    <div class="grid-item-inner <?php echo esc_attr($ct_animate); ?>">
                        ...
                        <div class="item--meta">
                            ...
                            <?php if($show_button == 'true') : ?>
                                <div class="item--readmore">
                                    <a class="btn-line" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                        <span>
                                            <?php if(!empty($button_text)) {
                                                echo esc_attr($button_text);
                                            } else {
                ...
                <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                    <div class="grid-item-inner <?php echo esc_attr($ct_animate); ?>">
                        ...
                        <div class="item--holder">
                            <?php if($show_button == 'true'): ?>
                                <div class="item--readmore">
                                    <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><i class="far fac-link"></i></a>
                                </div>
                            <?php endif; ?>
                            <div class="item--meta">
                                <?php if($show_title == 'true'): ?>
