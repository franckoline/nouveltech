...
function consultio_scripts() {
	...
	wp_enqueue_style( 'font-flaticon-v3', get_template_directory_uri() . '/assets/css/flaticon-v3.css', array(), '2.2.0' );
	wp_enqueue_style( 'font-flaticon-v4', get_template_directory_uri() . '/assets/css/flaticon-v4.css', array(), '2.2.0' );
	wp_enqueue_style( 'font-flaticon-v5', get_template_directory_uri() . '/assets/css/flaticon-v5.css', array(), '2.2.0' );
...
function consultio_admin_style() {
	$theme = wp_get_theme( get_template() );
	wp_enqueue_style( 'consultio-admin-style', get_template_directory_uri() . '/assets/css/admin.css' );
	wp_enqueue_style( 'font-material-icon', get_template_directory_uri() . '/assets/css/material-design-iconic-font.min.css', array(), '2.2.0' );
	wp_enqueue_style('font-awesome-v5', get_template_directory_uri() . '/assets/css/font-awesome5.min.css', array(), '5.8.0' );
	wp_enqueue_style( 'font-flaticon', get_template_directory_uri() . '/assets/css/flaticon.css', array(), '2.2.0' );
	wp_enqueue_style( 'font-flaticon-v2', get_template_directory_uri() . '/assets/css/flaticon-v2.css', array(), '2.2.0' );
