...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-case-study-carousel-layout4 dots-square ct-slick-slider">
                ...
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <div class="item--holder">
                        ...
                        <div class="item--readmore">
                            <a class="btn-arrow2" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
