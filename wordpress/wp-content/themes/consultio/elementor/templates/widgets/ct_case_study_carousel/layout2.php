...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-case-study-carousel-layout2 ct-slick-slider arrow-<?php echo esc_attr($settings['arrow_style']); ?>">
                ...
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <div class="item--holder">
                        ...
                        <div class="item--category">
                            <?php the_terms( $post->ID, 'case-study-category', ' <label>'.esc_html('Category:', 'consultio').'</label> ', ', ' ); ?>
                        </div>
                        <div class="item--readmore">
                            <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html('Read more', 'consultio'); ?><i class="far fac-angle-double-right"></i></a>
                        </div>
                    </div>
