...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-case-study-carousel-layout3 ct-slick-slider">
            ...
            <div class="carousel-item slick-slide">
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <div class="item--readmore">
                        <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><i class="fac fac-arrow-right"></i></a>
                    </div>
