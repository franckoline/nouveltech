...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="ct-testimonial ct-testimonial-carousel2 ct-slick-slider <?php echo esc_attr($settings['ct_animate']); ?>">
        <div <?php ct_print_html($widget->get_render_attribute_string( 'inner' )); ?>>
            
            <div class="ct-slick-nav" data-nav="3" data-dir="<?php echo esc_attr($carousel_dir); ?>">
