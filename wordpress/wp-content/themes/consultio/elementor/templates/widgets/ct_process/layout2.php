            ...
            <div class="ct-process-item">
                <div class="ct-process-item-inner">
                    <div class="ct-piechart ct-piechart-process wow flipInX">
                        <div class="item--value percentage" style="height: 165px;" data-size="165" data-bar-color="<?php if(!empty($primary_color)) { echo esc_attr($primary_color); } ?>" data-track-color="" data-line-width="14" data-percent="-75"></div>
                        <div class="ct-process-border"></div>
                        <?php if ( $has_icon ) : ?>
