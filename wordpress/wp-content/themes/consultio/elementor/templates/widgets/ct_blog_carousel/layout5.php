...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout5 ct-slick-slider <?php echo esc_attr($settings['style']); ?>">
            ...
            <div class="carousel-item slick-slide">
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <div class="entry-body">
                        ...
                        <div class="item-date"><i class="fac fac-clock"></i><?php $date_formart = get_option('date_format'); echo get_the_date($date_formart, $post->ID); ?></div>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
