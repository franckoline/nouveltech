...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout1 ct-slick-slider <?php echo esc_attr($settings['style']); ?> <?php if($settings['style'] == 'style4') { echo 'dot-style-u3'; } ?>">
