...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout8 ct-slick-slider <?php echo esc_attr($settings['style']); ?>">
                                ...
                                <?php if($show_author == 'true'): ?>
                                    <li class="item-author">
                                        <a href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>">
                                            ...
                                            <label><?php echo esc_html__('Posted by', 'consultio'); ?></label>
