...
?>
<div id="<?php echo esc_attr($html_id); ?>" class="ct-fancy-box same-height ct-fancy-box-layout7 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    ...
    <div class="item--holder">
        ...
        <?php if ( ! empty( $settings['btn_text'] ) ) { ?>
            <div class="item--button">
                <a <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>><?php echo esc_attr($settings['btn_text']); ?><i class="zmdi zmdi-long-arrow-right"></i></a>
            </div>
        <?php } ?>
    </div>
</div>