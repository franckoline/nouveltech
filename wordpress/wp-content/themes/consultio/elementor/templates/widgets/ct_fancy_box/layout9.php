...
?>
<div class="ct-fancy-box-layout3-wrap <?php echo esc_attr($settings['style_l9']); ?>">
    <div class="ct-fancy-box ct-fancy-box-layout9 <?php echo esc_attr($settings['style_l9']); ?> <?php if ( ! empty( $settings['btn_text'] ) ) { echo 'btn-active'; } ?> <?php if($settings['active'] == 'yes') { echo 'active'; } ?> <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
        ...
        <div class="item--holder">
            ...
            <?php if ( ! empty( $settings['btn_text'] ) ) { ?>
                <div class="item--button">
                    <a class="btn-line" <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>><span><?php echo esc_attr($settings['btn_text']); ?></span><i class="flaticonv4-next"></i></a>
                </div>
            <?php } ?>
        </div>
    </div>
