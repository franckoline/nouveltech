...
?>
<div class="ct-fancy-box ct-fancy-box-layout12 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    ...
    <?php if ( ! empty( $settings['link']['url'] ) ) { ?>
        <a class="item-readmore" <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>>+</a>
    <?php } ?>
</div>