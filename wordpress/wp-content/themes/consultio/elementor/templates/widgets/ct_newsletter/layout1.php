...
if(class_exists('Newsletter')) : 
	...
	?>
    <div id="<?php echo esc_attr($html_id); ?>" class="ct-newsletter ct-newsletter1 <?php echo esc_attr($style); ?> type-<?php echo esc_attr($color_gradient_type); ?> bg-image" <?php if($style == 'style5' && !empty($image_bg_box['url'])) { ?>style="background-image: url(<?php echo esc_url($image_bg_box['url']); ?>);"<?php } ?>>
